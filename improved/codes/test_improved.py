...
from utils_improved import get_dataloader_vocab_embedding
from train_improved import Trainer
from model_improved import LSTM_net_improved
...
def train_and_test(config):
    ...
    if pretrain:
        model = LSTM_net_improved(transformed_embedding,
                                  embed_size,
                                  vocab_size,
                                  hidden_dim,
                                  token_label_dim,
    ...
    lr_scheduler = StepLR(optimizer, step_size=8, gamma=0.5, verbose=True)
